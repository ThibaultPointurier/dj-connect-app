      ...
      <div v-else-if="step === 2">
        <form @submit.prevent="submitSecondStep">
          ...
          <div v-if="formStep1.role === 'dj'">
            <div class="mb-4">
              <label for="stageName" class="block text-sm font-medium text-gray-700">Nom de scène</label>
              <input
            ...
            <div class="mb-4">
              <label for="musicStyle" class="block text-sm font-medium text-gray-700">Style musical</label>
              <input
