  ...
  <div class="w-full h-full bg-white flex flex-col p-4">
    ...
    <div class="space-y-3">
      <div
        ...
        class="flex items-center p-3 rounded-lg cursor-pointer transition-colors hover:bg-blue-50 active:bg-blue-100"
      >
        <!-- Avatar + état en ligne éventuel -->
        <div class="relative">
          <img :src="conv.userImage" alt="Avatar" class="w-12 h-12 rounded-full object-cover" />
        ...
        <div
          ...
          class="ml-2 bg-blue-600 text-white text-xs font-semibold rounded-full w-5 h-5 flex items-center justify-center"
        >
          {{ conv.unreadCount }}
        </div>
      </div>
